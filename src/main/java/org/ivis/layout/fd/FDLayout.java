...
// -----------------------------------------------------------------------------
    ...
    /**
     * This method calculates the repulsion forces for the input node pair and returns the repulsion force
     * between these two node pair which repels these two node in order to resolve the overlap between them.
     */
    ...
    /**
     * This method calculates the distance between two nodes and returns the distance components in the
     * input array distanceComponents.
     */
    ...
    protected void calcRepulsionForce(FDLayoutNode nodeA, FDLayoutNode nodeB)
    {
        ...
        // two nodes overlap
        {
            ...
            repulsionForceX = repulsionForceComponents[0];
            repulsionForceY = repulsionForceComponents[1];
        }
        else
        // no overlap
        {
            // Get the distance between two nodes.
            this.getDistanceBetweenTwoNodes(nodeA,nodeB,distanceComponents);
            distanceX = distanceComponents[0];
            distanceY = distanceComponents[1];
